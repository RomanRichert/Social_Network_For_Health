package com.healyourself.ok_treatments.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.healyourself.ok_treatments.controller.*.*(..))")
    public void controllerLog() {
    }

    @Pointcut("execution(public * com.healyourself.ok_treatments.service.*.*(..))")
